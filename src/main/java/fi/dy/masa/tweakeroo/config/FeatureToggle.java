...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    TWEAK_ANNOUNCE_EXPOSED_BLOCKS   ("tweakAnnounceExposedBlocks",          false, "",    "Plays a sound when any of the blocks in announceBlocks are exposed via mining"),
    ...
    TWEAK_BLOCK_SWITCH              ("tweakBlockSwitch",                    false, "",    "Enables automatically switching to a building block when right-clicking on a non-interactive block with a tool."),
    ...
    TWEAK_STATUS_EFFECT_TIME_HUD    ("tweakStatusEffectTimeHUD",            false, "",    "When enabled, displays the time for each applied status effect beneath the effect in the ingame HUD."),
